...
export function AccountantDocumentDetailView({ documentId }: { documentId: string }) {
  ...
  return <>
    ...
    <div className="my-5"><DocumentReviewPanel officeId={officeId} companyId={companyId} documentId={documentId} status={d.review?.status} /></div>
    <div className="my-5 grid gap-5 lg:grid-cols-2"><DocumentNotesPanel officeId={officeId} companyId={companyId} documentId={documentId} /><DocumentTagsPanel officeId={officeId} companyId={companyId} documentId={documentId} /></div>
    ...
    <div className="my-5"><DocumentRequestsPanel officeId={officeId} companyId={companyId} documentId={documentId} /></div>
  </>;
}
