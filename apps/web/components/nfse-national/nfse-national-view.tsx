        ...
        {data.map((company) => (
          <Card key={company.companyId} className="p-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-6 mb-4">
              <div className="p-3 rounded-xl bg-white border border-line"><p className="text-xs text-subtle">Prestador cadastrado</p><p className="text-2xl font-extrabold">{company.providerRegistered ? "?" : "?"}</p></div>
